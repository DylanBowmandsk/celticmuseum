        ...
        <div className="flex justify-center yw-1/4 my-14" >
            <div>
                ...
                <div className='flex items-center'>
                    <button type="submit"  onClick={() => {uploadImage(); setUploading(true)}} className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full my-5">Submit</button>
